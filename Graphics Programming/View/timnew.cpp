...
int main()
{
    ...
    View view(FloatRect(0, 0, res.x, res.y));
    // 2. Background
    Texture bgTexture;
    ...
    // Prepare the sound (Chop, out of time, death)
    ...
    while (rm.isOpen())
    {
        ...
        if (acceptInput)
        {
            ...
            if (Keyboard::isKeyPressed(Keyboard::Right))
            {
                ...
                // Set Axe Position
                // axeSprite.setPosition(AXE_POSITION_RIGHT, axeSprite.getPosition());
            ...
            if (Keyboard::isKeyPressed(Keyboard::Left))
            {
                ...
                // Set Axe Position
                // axeSprite.setPosition(AXE_POSITION_LEFT, axeSprite.getPosition());
        ...
        if (!paused)
        {
            ...
            for (int i = 0; i < NUM_BRANCHES; i++)
            {
                if (branchPosition[i] == side::LEFT)
                {
                    ...
                    Branches[i].setPosition(610, branchHeight);
                }
